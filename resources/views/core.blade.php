	...
	<section class="section section--core-summary">
		<div class="section__content">
			...
			<div class="subsection subsection--setup">
				...
				<p class="subsection__content">Becoming a host to share your computers resources on the <span class="linebreak d-block d-lg-block"></span>X&nbsp;Core network is quick and easy. Simply download the desktop application, create your node, and your device will automatically be connected. It will always be connected unless you say otherwise. All the hard work has been done for you.</p>
