		...
		<div class="container">
			<div class="section__content">
				...
				<span class="d-none d-lg-block">
					By combining <em>distributed</em> technology and <em>end-to-end encryption</em>, X Cloud provides the highest possible level of security and privacy. Take true control of <em>your</em> information.
				</span>
